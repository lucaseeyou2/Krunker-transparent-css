...
## Usage 
The usage of the following ressources can only be used on Browsers and Also the client version of Krunker. Download the following files and put them into a folder in your documents named **'Krunker ressource swapper'** and put the css folder inside. On the browser version of the game, put the css folder in the Krunker ressource swapper as mentionned in the readme. On the client, your ressource swapper should look like something like [this](https://www.dropbox.com/s/k7nwz5k8xzblsiu/This.png?dl=0).
